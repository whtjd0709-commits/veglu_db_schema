...
CREATE TABLE users (
    ...
    user_provider VARCHAR(50) NOT NULL COMMENT 'LOCAL/KAKAO/NAVER/GOOGLE/APPLE',
    user_role VARCHAR(20) NOT NULL COMMENT 'USER / OWNER / ADMIN',
...
CREATE TABLE restaurants (
    ...
    restaurant_location POINT SRID 4326 NOT NULL COMMENT '위경도 좌표 (MySQL Spatial, 공간 인덱스)',
    ...
    restaurant_price_range VARCHAR(50) NOT NULL COMMENT '가격대 (LOW~VERY_HIGH)',
    restaurant_business_hours JSON NOT NULL COMMENT '요일별 영업시간',
    restaurant_holidays VARCHAR(255) COMMENT '휴무일 (정기/임시)',
